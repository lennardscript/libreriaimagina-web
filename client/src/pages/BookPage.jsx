          ...
          >
            ...
            <div className="mt-8 flex justify-between">
              <div className="max-w-[35ch] space-y-2">
                ...
                <p className="text-sm">Producto mejor valorado</p>
            ...
            <form className="mt-8">
              <div className="mt-8 flex gap-4">
                ...
                <button className="block w-full p-5 text-sm font-medium">
                  ...
                  >
                    <span
                      className="absolute inset-0 translate-x-0 translate-y-0 bg-red-500 transition-transform group-hover:translate-y-1.5 group-hover:translate-x-1.5"
                    ></span>
